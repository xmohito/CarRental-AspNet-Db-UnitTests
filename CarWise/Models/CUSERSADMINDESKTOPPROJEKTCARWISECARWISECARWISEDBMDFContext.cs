...
{
    public partial class CUSERSADMINDESKTOPPROJEKTCARWISECARWISECARWISEDBMDFContext : DbContext
    {
        public CUSERSADMINDESKTOPPROJEKTCARWISECARWISECARWISEDBMDFContext()
        {
        }

        public CUSERSADMINDESKTOPPROJEKTCARWISECARWISECARWISEDBMDFContext(DbContextOptions<CUSERSADMINDESKTOPPROJEKTCARWISECARWISECARWISEDBMDFContext> options)
            : base(options)
        {
        }
